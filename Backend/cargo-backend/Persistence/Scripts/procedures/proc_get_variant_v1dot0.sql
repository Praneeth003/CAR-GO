...
DROP PROCEDURE IF EXISTS proc_get_variant_v1dot0 #

CREATE PROCEDURE proc_get_variant_v1dot0(
...
BEGIN
    ...
    v_sub_query5 ," AND ",v_sub_query6," AND ",v_sub_query7," AND ",v_sub_query8," AND ", v_sub_query9);	
