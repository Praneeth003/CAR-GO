...
DROP PROCEDURE IF EXISTS proc_get_variant_s_v1dot0 #

CREATE PROCEDURE proc_get_variant_s_v1dot0(
...
BEGIN
	...
	DECLARE EXIT HANDLER FOR SQLEXCEPTION BEGIN
        GET DIAGNOSTICS CONDITION 1
            ...
            SET out_err_msg = CONCAT('proc_get_variant_s_v1dot0',out_err_msg);
            SET out_status = 500;
	END;
    ...
    v_sub_query5 ," AND ",v_sub_query6," AND ",v_sub_query7," AND ",v_sub_query8, " AND a.c_variant_status = '1'");	
